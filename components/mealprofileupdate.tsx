...
export default function MealProfileUpdate({shopId, mealData, updateMenuOnMealEdit, closeModal}: PropsType){
    ...
    async function submitFormData() {
        ...
        try {
           ...
           const { data } = await axios.post(`${DOMAIN_URL}/api/updatemealprofile`, formData, { headers: headers });
           setInPost(false);
            ...
            <KeyboardAvoidingView  
                ...
                <ScrollView style={{paddingHorizontal: 5}}>
                    <View style={[styles.itemCenter, styles.listItem]}>
                        <Text style={styles.headingText}>{`Profile Update for ${mealData.mealname}`}</Text>
                    </View>       

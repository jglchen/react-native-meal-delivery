...
export default function ForgotPasswd({ route, navigation }: PropsType) {
    ...
    async function submitPasswdReset(){
       ...
       if (!passwd || !passwd2){
          ...
          if (!passwd){
             (passwdEl as any).current.focus();
          }else{
             (passwd2El as any).current.focus();
          }
          return;
       }
